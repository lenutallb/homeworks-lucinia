...
public class ComparSiruri {
    //citeste de doua ori cate 5 numere si imprima pe cele comune celor doua seturi
    ...
    public static int getNewLgth(int lgthTabs, int[] table1) {
        ...
        for (int i = 0; i < contor - 1; i++) {
            if (!noshift) {
                i=i-1; noshift=true;} // daca revin la inceputul buclei dupa un shift peste dublura
        ...
        // cazul cand raman cu doua elemente identice, tratat separat ca altfel am exceptie depasire dimensiune tablou
        if ((contor == 2) && (table1[contor-1]==table1[contor-2])) {contor = contor -1;}
